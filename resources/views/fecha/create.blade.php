                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('fecha.store') }}" method="POST">
                            @csrf
                            <h6 class="text-gray-800 text-center text-base mb-8 w-2/4">Ingresa la información para crear un ciclo</h6>
                            <div class="pl-lg-4">
                                <div class="row mb-10">
                                ...
                                <div class="text-center mb-6">
                                    <span class="sm:ml-3">
                                        <button class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-green-600  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 hover:scale-105">
